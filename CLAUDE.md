...
- **4,785 entries** in `notes_chemistry.json` (was 1,619; +3,166 from Parfumo import)
...
- Kaggle "Parfumo Fragrance Dataset" (59,325 rows) imported via `scripts/import_parfumo_fast.py`
